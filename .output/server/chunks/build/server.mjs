import { version, inject, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, defineComponent, computed, h, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, hasInjectionContext, unref, resolveComponent, onServerPrefetch, mergeProps, createApp, effectScope, reactive, getCurrentScope, shallowRef, toRef, withCtx, createVNode, createTextVNode, toDisplayString, onErrorCaptured, resolveDynamicComponent, isReadonly, isRef, isShallow, isReactive, toRaw, toValue } from 'vue';
import { $ as $fetch$1, F as baseURL, c as createError$1, G as defu, p as publicAssetsURL, I as parseQuery, J as klona, K as getContext, L as createHooks, M as hasProtocol, N as joinURL, O as defuFn, P as isScriptProtocol, Q as withQuery, R as sanitizeStatusCode, w as withTrailingSlash, S as withoutTrailingSlash, T as titleCase, U as toRouteMatcher, V as createRouter$1, W as camelCase, A as parseURL, X as withoutBase, Y as stringifyQuery, Z as withLeadingSlash, _ as withBase } from '../nitro/nitro.mjs';
...
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderTeleport, ssrRenderList, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Ah6MX08s.mjs')
  }
];
...
function isChangingPage(to, from) {
  ...
  const areComponentsSame = to.matched.every(
    (comp, index2) => {
      var _a, _b;
      return comp.components && comp.components.default === ((_b = (_a = from.matched[index2]) == null ? undefined : _a.components) == null ? undefined : _b.default);
    }
  );
...
function routeRuleOgImage(nuxtApp) {
  nuxtApp.hooks.hook("app:rendered", async (ctx) => {
    ...
    routeRules = normaliseOptions(defu((_f = (_e = (_d = nuxtApp.ssrContext) == null ? undefined : _d.event.context._nitro) == null ? undefined : _e.routeRules) == null ? undefined : _f.ogImage, routeRules, {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        if (visible.value) {
          _push2(`<div class="preloader" aria-label="Loading" role="progressbar" data-v-148e9fee><div class="preloader-grain" aria-hidden="true" data-v-148e9fee></div><div class="grid-lines" aria-hidden="true" data-v-148e9fee><!--[-->`);
          ssrRenderList(verticalCount, (i) => {
            _push2(`<div class="grid-line vertical" style="${ssrRenderStyle({ left: i / (verticalCount + 1) * 100 + "%" })}" data-v-148e9fee></div>`);
          });
          _push2(`<!--]--><!--[-->`);
          ssrRenderList(horizontalCount, (i) => {
            _push2(`<div class="grid-line horizontal" style="${ssrRenderStyle({ top: i / (horizontalCount + 1) * 100 + "%" })}" data-v-148e9fee></div>`);
          });
          _push2(`<!--]--></div><div class="grid-labels" aria-hidden="true" data-v-148e9fee><!--[-->`);
          ssrRenderList(gridLabels, (label, idx) => {
            _push2(`<span class="grid-label" style="${ssrRenderStyle({ top: label.y + "%", left: label.x + "%" })}" data-v-148e9fee>${ssrInterpolate(label.text)}</span>`);
          });
          _push2(`<!--]--></div><div class="words-wrap" data-v-148e9fee><!--[-->`);
          ssrRenderList(words, (word, idx) => {
            _push2(`<div class="word-row" data-v-148e9fee><span class="word-index hidden sm:inline" data-v-148e9fee>${ssrInterpolate(String(idx + 1).padStart(2, "0"))}</span><span class="word-text" data-v-148e9fee>${ssrInterpolate(word)}</span></div>`);
          });
          _push2(`<!--]--></div><div class="bottom-line" data-v-148e9fee><span class="bottom-dash" data-v-148e9fee></span><span class="bottom-label" data-v-148e9fee>Andrew Long</span><span class="bottom-dash" data-v-148e9fee></span></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-148e9fee"]]);
...
const _imports_0 = publicAssetsURL("/images/IDLOGO.webp");
const _sfc_main$5 = {
  __name: "Header",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({
        class: ["site-header", { "is-scrolled": isScrolled.value }]
      }, _attrs))} data-v-87f442a4><div class="header-inner" data-v-87f442a4>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} class="brand-logo" alt="iDrew" data-v-87f442a4${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(`<nav class="desktop-nav" aria-label="Main navigation" data-v-87f442a4><!--[-->`);
      ...
      _push(`<!--]--><div class="nav-divider" aria-hidden="true" data-v-87f442a4></div><!--[-->`);
      ssrRenderList(socialLinks, (social) => {
        _push(`<a${ssrRenderAttr("href", social.url)} target="_blank" rel="noopener noreferrer" class="icon-item"${ssrRenderAttr("aria-label", social.label)} data-v-87f442a4>`);
      ...
      _push(`<!--]--></nav><button type="button" class="mobile-toggle"${ssrRenderAttr("aria-expanded", showMenu.value)} aria-controls="mobile-nav" data-v-87f442a4><span class="sr-only" data-v-87f442a4>${ssrInterpolate(showMenu.value ? "Close menu" : "Open menu")}</span>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: showMenu.value ? "heroicons:x-mark" : "heroicons:bars-3",
        class: "w-5 h-5",
        "aria-hidden": "true"
      }, null, _parent));
      _push(`</button></div><div style="${ssrRenderStyle(showMenu.value ? null : { display: "none" })}" id="mobile-nav" class="mobile-nav" data-v-87f442a4><!--[-->`);
      ssrRenderList(navigationLinks, (link) => {
        _push(ssrRenderComponent(_component_NuxtLink, {
          key: link.to,
          to: link.to,
      ...
      _push(`<!--]--><div class="mobile-divider" data-v-87f442a4></div><div class="mobile-socials" data-v-87f442a4><!--[-->`);
      ssrRenderList(socialLinks, (social) => {
        _push(`<a${ssrRenderAttr("href", social.url)} target="_blank" rel="noopener noreferrer" class="mobile-social-item" data-v-87f442a4>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: social.icon,
          class: "w-4 h-4",
          "aria-hidden": "true"
        }, null, _parent));
        _push(`<span data-v-87f442a4>${ssrInterpolate(social.label)}</span></a>`);
      });
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-87f442a4"]]);
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ class: "w-full border-t border-stone-200 bg-[var(--bg)]" }, _attrs))} data-v-4714d7b0><div class="max-w-6xl mx-auto px-4 sm:px-6" data-v-4714d7b0><div class="flex items-center justify-between py-4" data-v-4714d7b0><span class="footer-text" data-v-4714d7b0>Long Beach // MS</span><span class="footer-text" data-v-4714d7b0>© ${ssrInterpolate(unref(year))} Andrew Long</span></div></div></footer>`);
    };
  }
};
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-4714d7b0"]]);
const RADIUS = 18;
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        style: showButton.value ? null : { display: "none" },
        class: ["scroll-btn", { "is-clicking": isAnimating.value }],
        "aria-label": "Scroll to top"
      }, _attrs))} data-v-80f5af46><svg class="progress-ring" viewBox="0 0 44 44" aria-hidden="true" data-v-80f5af46><circle class="ring-track" cx="22" cy="22" r="18" data-v-80f5af46></circle><circle class="ring-fill" cx="22" cy="22" r="18" style="${ssrRenderStyle({ strokeDashoffset: progressOffset.value })}" data-v-80f5af46></circle></svg><svg class="arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true" data-v-80f5af46><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18" data-v-80f5af46></path></svg><span class="tooltip" aria-hidden="true" data-v-80f5af46>Back to top</span></button>`);
    };
  }
});
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-80f5af46"]]);
const _sfc_main$2 = {
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Preloader = __nuxt_component_0$1;
      const _component_Header = __nuxt_component_1;
      const _component_NuxtPage = __nuxt_component_2;
      const _component_Footer = __nuxt_component_3;
      const _component_ScrollToTop = __nuxt_component_4;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex flex-col" }, _attrs))}>`);
      if (unref(showPreloader)) {
        _push(ssrRenderComponent(_component_Preloader, {
          onDone: ($event) => showPreloader.value = false
        }, null, _parent));
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-COpzEb5r.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CqC-EFDv.mjs'));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-B7odGILJ.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$2 as a, useNuxtApp as b, createError as c, __nuxt_component_0 as d, entry$1 as default, useOgImageRuntimeConfig as e, useSiteConfig as f, injectHead as i, useHead as u };
