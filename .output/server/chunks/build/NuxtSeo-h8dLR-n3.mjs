import { e as useOgImageRuntimeConfig, f as useSiteConfig, b as __nuxt_component_0$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const themeRgb = computed(() => {
      var _a;
      return (_a = themeHex.value.replace("#", "").match(/.{1,2}/g)) == null ? undefined : _a.map((v) => Number.parseInt(v, 16)).join(", ");
    });
...
//# sourceMappingURL=NuxtSeo-h8dLR-n3.mjs.map
