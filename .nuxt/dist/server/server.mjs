import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, ref, watchEffect, watch, h, shallowRef, isReadonly, onServerPrefetch, isRef, defineComponent, resolveComponent, computed, isShallow, isReactive, toRaw, defineAsyncComponent, toValue, useSSRContext, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, provide, Suspense, nextTick, Fragment, Transition, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
...
import { hasProtocol, isScriptProtocol, joinURL, withQuery, parseQuery, withTrailingSlash, withoutTrailingSlash, parseURL, withLeadingSlash, withBase, withoutBase, stringifyQuery } from "ufo";
import "destr";
...
import { ssrRenderTeleport, ssrRenderList, ssrRenderStyle, ssrInterpolate, ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Ah6MX08s.js")
  }
];
...
function getOgImagePath(pagePath, _options) {
  ...
  const path = joinURL("/", baseURL2, `__og-image__/${import.meta.prerender ? "static" : "image"}`, pagePath, `og.${options.extension}`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-COpzEb5r.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CqC-EFDv.js"));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-B7odGILJ.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
