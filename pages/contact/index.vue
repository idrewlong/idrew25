...
useSeoMeta({
	title: 'Contact - Andrew Long | Software Engineer',
	ogTitle: 'Get in Touch with Andrew Long - Software Engineer',
	description:
			...
			<div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
				...
				<form @submit.prevent="submitForm" class="space-y-6">
					...
					<button
						...
						class="w-full md:w-auto px-8 py-3 bg-gradient-to-r from-orange-500 to-rose-500 text-white font-semibold rounded-lg shadow-lg hover:opacity-90 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50"
					>
